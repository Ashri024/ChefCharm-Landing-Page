...
function ContentBox() {
  return (
    <div id="contextBox" className="lg:w-96 w-80 z-40 h-auto min-h-5 border-solid border-2 border-white fixed bottom-4 max-[768px]:hidden lg:bottom-10 left-4 lg:left-8 p-4 rounded-lg backdrop-blur -translate-x-full opacity-0">
