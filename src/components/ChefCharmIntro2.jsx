...
function ChefCharmIntro2() {
  ...
  return (
    <div className="relative z-10 text-white h-screen p-4 overflow-hidden max-w-[1600px] mx-auto opacity-100" id="chefCharmIntro">
      <div className="fixed top-44 w-full text-center text-white font-bold max-[768px]:font-semibold -translate-y-full opacity-0 flex gap-6 max-[768px]:gap-2 items-center left-1/2 -translate-x-1/2 justify-center p-4" style={{
        zIndex: 100
      }} id={"getStarted"}>
      ...
      <img src={welcomeSvg} alt="Welcome to" className='w-48 max-[768px]:w-40 top-20 left-1/2 -translate-x-1/2 max-[768px]:top-40 fixed opacity-0' id='welcome'/>
        <div className="flex justify-center items-center fixed w-full top-48 gap-12 max-[768px]:gap-0 left-0" id="chefCharmFlex">
            <img id="chefSvg" src={ChefSvg} alt="Chef" className='w-48 max-[768px]:w-40 relative left-[-100px] opacity-0'/>
            <img id="charmSvg" src={CharmSvg} alt="Charm" className='w-48 max-[768px]:w-40 relative left-[100px] opacity-0'/>
        </div>
